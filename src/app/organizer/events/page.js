                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex bg-[#272727] rounded-xl p-1 border border-[#333]">
                                <button 
                                    ...
                                    className={`px-3 py-1.5 rounded-lg text-sm transition-colors ${view === "grid" ? "bg-[#E21D8F] text-black" : "text-gray-400 hover:text-white"}`}
                                >
                                ...
                                <button 
                                    ...
                                    className={`px-3 py-1.5 rounded-lg text-sm transition-colors ${view === "list" ? "bg-[#E21D8F] text-black" : "text-gray-400 hover:text-white"}`}
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {events.map((event) => (
                                <div key={event.id} className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-[#2f2f2f] transition-colors border-b border-[#333] last:border-0">
                                    ...
                                    <div className="col-span-2 flex justify-end gap-2">
                                        ...
                                        <Link href={`/organizer/events/${event.id}/edit`} className="px-3 py-1.5 bg-[#E21D8F] rounded-lg text-xs font-semibold text-black hover:opacity-90 transition-all">
                                            Edit
                                        </Link>
